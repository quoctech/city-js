...
function random() {
    ...
    var z = 100; // chỉ sử dụng được z trong scope hàm random.
...
console.log('Sau khi thay đổi y', y); // 20 vì random đã được gọi và đã thay đổi giá trị của y từ 15 lên 20.
